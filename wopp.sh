...
\033[1;97-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
\033[1;94FACEBOOK
\033[1;94                 Somi awan and maria malik
\033[1;96-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
\033[1;95WhatsApp
\033[1;95                03455453538
\033[1;91-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*
\033[1;96Note:
\033[1;96    Don't Copy  without my permission
\033[1;91----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*
\033[1;92----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*
...
os.system("clear")
print "\033[1;92m /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////"
print  """\033[1;97mNote Don't be use illigal I am not responsible for any illigal activity
\033[1;91----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*
\033[1;92----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*----*
\033[1;93DEVOLPER
\033[1;93                  SOMI-MARIA
...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;96m[◆○] \x1b[1;92mUsername Of Tool \x1b[1;93m°•°•> ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;96m[◆○] \x1b[1;92mPassword Of Tool \x1b[1;93m°•°•>")
        if (password == CorrectPassword):
            print "Logged in successfully as Somi " + username
            loop = 'false'
        else:
            print "Wrong Password"
            os.system('xdg-open https://youtu.sommi rapper')
    else:
        print "Wrong Username"
        os.system('xdg-open https://youtu.sommirapper')
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('\033[1;96m[☆] \x1b[1;92mLOGIN WITH FACEBOOK Acc \x1b[1;96m[☆]' )
		id = raw_input('\033[1;96m[+] \x1b[1;94mID/Email \x1b[1;91m: \x1b[1;94m')
		pwd = raw_input('\033[1;96m[+] \x1b[1;95mPassword \x1b[1;91m: \x1b[1;96m')
		tik()
		try:
		...
		if 'save-device' in url:
			try:
				...
				print"\n\033[1;96m[!] \x1b[1;97mThere is no internet connection"
				keluar()
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;97mIt seems that your account has a checkpoint")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;96m[!] \x1b[1;97mPassword/Email is wrong")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;96m[!] \x1b[1;97mToken invalid"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	try:
		...
		os.system('clear')
		print"\033[1;96m[!] \033[1;97mIt seems that your account has a checkpoint"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		print"\033[1;96m[!] \x1b[1;97mThere is no internet connection"
		keluar()
	os.system("clear")
	print logo
	print 42*"\033[1;96m="
	...
	print 42*"\033[1;96m="
	print "\x1b[1;96m[\x1b[1;92m1\x1b[1;96m]\x1b[1;92m Start Hacking"
...
def super():
	...
	print logo
	print 42*"\033[1;96m="
	print "\x1b[1;96m[\x1b[1;92m1\x1b[1;96m]\x1b[1;92m Crack From Friend List"
...
def pilih_super():
	...
	print "\033[1;96m[+] \033[1;92mTotal IDs \033[1;91m: \033[1;97m"+str(len(id))
	jalan('\033[1;96m[✺] \033[1;92mStarting \033[1;97m...')
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96m[\033[1;97m✸\033[1;96m] \033[1;92mCracking \033[1;97m"+o),;sys.stdout.flush();time.sleep(1)
	print
	print('\x1b[1;96m[!] \x1b[1;97mTo Stop Process Press CTRL Then Press z')
	print 42*"\033[1;96m="
